...
*Sequences are clustered by exact sequence match within a taxid.*
*Ambiguous characters are treated as a mismatch for clustering but always result in a match for identity calculation.*
